...
namespace CS240Assignment1 {
	...
	/// <summary>
	/// Summary for errorWindow
	/// </summary>
	public ref class errorWindow : public System::Windows::Forms::Form {
	public:
		errorWindow(void) {
			InitializeComponent();
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonOK->Click += gcnew System::EventHandler(this, &errorWindow::buttonOK_Click);
			// 
			// textLabel
			// 
