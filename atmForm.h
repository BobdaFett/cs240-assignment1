...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &atmForm::textBox1_KeyDown);
			// 
			// textBox2
			// 
...
private: System::Void textBox1_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
	if (e->KeyCode == Keys::Enter && current_atm.get_state() != state::ACCOUNT && current_atm.get_state() != state::TRANSACTION) {
		buttonA_Event();
	}
}
};
